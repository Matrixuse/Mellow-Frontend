            ...
            <div ref={ref} className={`relative inline-block ${className || ''}`}>
                ...
                {isOpen && (
                    ...
                    <div className="absolute right-0 top-full mt-2 w-40 max-w-xs bg-gray-800 border border-gray-700 rounded-md shadow-lg text-left py-0.5 z-50">
                        ...
                        <button onClick={(e) => { e.stopPropagation(); setOpenMenuId(null); handlers.onShowArtist && handlers.onShowArtist(song.artist); }} className="w-full text-left px-3 py-2 hover:bg-[#121a20] text-gray-100">Artist</button>
