    ...
    return (
      <div className="fixed bottom-0 left-0 right-0 z-30 md:hidden">
          ...
          <div className="flex-1 flex justify-center">
            <div className="flex w-full max-w-[180px] justify-between">
              <button onClick={goHome} aria-label="Home" className={`flex flex-col items-center ml-6 ${isActive('/') ? 'text-white' : 'text-gray-300 hover:text-white'}`}>
              ...
              <button onClick={openPlaylists} aria-label="Playlists" className={`flex flex-col items-center mr-6 ${isActive('/playlists') ? 'text-white' : 'text-gray-300 hover:text-white'}`}>
