                ...
                <div className="space-y-3 max-h-96 overflow-y-auto pr-2">
                    {queue.map((song, idx) => (
                        <div key={song.id || idx} className="flex items-center gap-3">
                            <img src={song.coverUrl} alt={song.title} className="w-12 h-12 rounded-md object-cover" onError={(e) => { e.target.onerror = null; e.target.src='https://placehold.co/200x200/1F2937/FFFFFF?text=Music'; }} />
